...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_fa643065900a2e464b4dc7a95f7487b6e82106e7": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){window.addEventListener ("resize" , ()=> ($1));})());
            },
            "__extjs_9960a6fc4f580b87f1d6b0208b5f9d36bffcf638": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return window.performance.now ();})());
            },
            "__extjs_9a466f138efdc1dfa3889b6eb0d029044afe5f02": function($0) {
            ...
            "__extjs_505c516849f975b3f6c4fe92e3e183511ce8696a": function($0, $1, $2, $3) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);Module.STDWEB_PRIVATE.from_js($0, (function(){($1). viewport (0 , 0 , ($2). width , ($3). height);})());
            },
            "__extjs_9fe993715b1d650b50265225d5274f2dde615943": function($0, $1, $2, $3, $4, $5, $6) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);$4 = Module.STDWEB_PRIVATE.to_js($4);$5 = Module.STDWEB_PRIVATE.to_js($5);$6 = Module.STDWEB_PRIVATE.to_js($6);Module.STDWEB_PRIVATE.from_js($0, (function(){($1). clearColor (($2), ($3), ($4), 1); ($5). clear (($6). COLOR_BUFFER_BIT);})());
            },
            "__extjs_6358b85bc12147bf0ca48a63c0c8f918c3796eb0": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){console.error (($1))})());
            },
            "__extjs_14d1e8f18f3d42fc4803483bde04f277703f43b5": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){console.warn (($1))})());
            },
            "__extjs_2a94cb2fb4ae647e145d66d9a60d359caa2ade07": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){console.info (($1))})());
            },
            "__extjs_8d1b0bf4644d57621895955ec2608282a3215e28": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){console.log ("DEBUG: " + ($1))})());
            },
            "__extjs_daef309faceb10b03988085a922eb1221f66db72": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){console.log ("TRACE: " + ($1))})());
            },
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'dubni'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'dubni':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" ) {
        ...
        const wasm_path = path.join( __dirname, "dubni.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "dubni.wasm" )
